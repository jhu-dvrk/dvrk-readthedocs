...
.. tabs::
   ...
   .. tab:: Ubuntu 18.04
      ...
      .. code-block:: bash
         ...
         sudo apt install libraw1394-dev libncurses5-dev qtcreator swig sox espeak cmake-curses-gui cmake-qt-gui git subversion gfortran libcppunit-dev libqt5xmlpatterns5-dev libhidapi-dev python-vcstool python-catkin-tools
   ...
   .. tab:: Ubuntu 20.04
      ...
      .. code-block:: bash
         ...
         sudo apt install libraw1394-dev libncurses5-dev qtcreator swig sox espeak cmake-curses-gui cmake-qt-gui git subversion gfortran libcppunit-dev libqt5xmlpatterns5-dev libhidapi-dev python3-pyudev python3-vcstool python3-catkin-tools python3-osrf-pycommon
